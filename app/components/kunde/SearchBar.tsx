...
export default function SearchBar({
  ...
  return (
    ...
    <form onSubmit={handleSubmit} className="w-full" role="search">
      <div className="flex items-center gap-3 border sm:px-4 border-gray-400 rounded-xl px-4 py-3 focus-within:border-blue-400 focus-within:ring-2 focus-within:ring-blue-100 transition-all bg-white">
    ...
    {/* må gjøres funksjonelt også  */}
      {popularSearches && popularSearches.length > 0 && (
        <div className="flex items-center gap-2 mt-3 flex-wrap">
          <span className="text-xs font-medium text-gray-500 mr-1">Populære søk:</span>
